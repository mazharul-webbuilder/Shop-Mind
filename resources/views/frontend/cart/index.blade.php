                    ...
                    <ul role="list" class="border-t border-b border-gray-200 divide-y divide-gray-200">
                        @forelse($cart->items as $item)
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ $item->product->image }}" alt="{{ $item->product->name }}" class="w-16 h-16 rounded-md object-center object-cover sm:w-20 sm:h-20">
                            </div>

                            <div class="ml-3 flex-1 flex flex-col justify-between sm:ml-4">
                                    ...
                                    <p class="mt-2 flex text-sm text-gray-700 space-x-2">
                            ...
                            <li class="py-12 text-center">
                                ...
                                <div class="mt-6">
                                    <a href="{{ route('frontend.home') }}"
                                        class="text-indigo-600 font-medium hover:text-indigo-500">Continue Shopping &rarr;</a>
                                </div>
                            </li>
                        @endforelse
                    </ul>
                ...
                <section aria-labelledby="summary-heading"
                    ...
                    <div class="mt-6">
                        <a href="{{ route('frontend.checkout.index') }}"
                            class="w-full bg-indigo-600 border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 text-center block">
                            Checkout
                        </a>
                    </div>
                </section>
